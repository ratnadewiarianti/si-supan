...
class KegiatanModel extends Model
{
    ...
    protected $allowedFields    = ['id_urusan','id_bidang_urusan', 'id_program','kode_kegiatan','nama_kegiatan'];
    ...
    public function getKegiatan()
    {
        ...
        ->join('bidang_urusan', 'bidang_urusan.id = kegiatan.id_bidang_urusan')
