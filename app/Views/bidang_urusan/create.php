    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Tambah Data Bidang Urusan</h4>
                        <form action="/bidang_urusan/store/" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="kode_bidang_urusan" class="form-control"  required>
                            </div>
                            <div class="form-group">
                                <label>Nama Bidang Urusan</label>
                                <input type="text" name="nama_bidang_urusan" class="form-control"  required>
                            </div>
