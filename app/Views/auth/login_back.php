...
<head>
    ...
    <style>
        .content-wrapper {
            background-image: url('assets/images/dispusipnew.jpg');
...
<body>
    ...
    <center> 
        <img src="assets/images/logo_bulat.png" alt="logo" style="box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.5); border-radius: 50%;"> 
    </center>
</div>
