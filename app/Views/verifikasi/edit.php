            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="/verifikasi/update/<?= $verifikasi['id']; ?>" method="post">
                            ...
                            <input type="hidden" name="file_spj_lama" value="<?= $verifikasi['file_spj']; ?>">

                            <div class="form-group">
                                <label>File Kwitansi</label> <br>
                                <label><small>Upload dalam Format PDF</small></label> <br>
                                <input type="file" name="file_kwitansi" id="file_kwitansi" class="form-control-file"  value="<?= $verifikasi['file_kwitansi']; ?>" accept=".pdf">
                            </div> -->
