            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-10">
                                <p class="card-title">Data Penatausahaan</p>
                            </div>
                            <div class="col-2 text-end">
                                <a class="btn btn-success btn-sm" href="/penatausahaan/create">Tambah Data</a>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                            ...
                                            <?php if (!empty($penatausahaan)) : ?>
                                                ...
                                                <?php foreach ($penatausahaan as $row) : ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['nama_karyawan_1']; ?></td>
                                                        <td><?= $row['nama_karyawan_2']; ?></td>
