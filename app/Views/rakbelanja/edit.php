                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="id_rekening" required>
                                    ...
                                    <?php foreach ($rekening as $key) : ?>
                                        <option value="<?= $key['id']; ?>" <?php if ($key['id'] == $rakbelanja['id_rekening']) echo 'selected="selected"'; ?>><?= $key['akun']; ?>.<?= $key['kelompok']; ?>.<?= $key['jenis']; ?>.<?= $key['objek']; ?>.<?= $key['rincian_object']; ?>.<?= $key['sub_rincian_objek']; ?> - <?= $key['uraian_akun']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
