                        ...
                        <form action="/karyawan/update/<?= $karyawan['id']; ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select name="kategori_pegawai" class="form-control" required>
                                    <option value="PNS"
                                        <?= ($karyawan['kategori_pegawai'] == 'PNS') ? 'selected' : ''; ?>>PNS</option>
                                    <option value="PTT"
                                        <?= ($karyawan['kategori_pegawai'] == 'PTT') ? 'selected' : ''; ?>>PTT</option>
                                    <option value="Tenaga Ahli"
                                        <?= ($karyawan['kategori_pegawai'] == 'Tenaga Ahli') ? 'selected' : ''; ?>>
                                        Tenaga Ahli</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label>No Rek</label>
                                <input type="text" name="norek" class="form-control" value="<?= $karyawan['norek']; ?>"
                                    required>
                            </div>
                            ...
                            <!-- <div class="form-group">
                                ...
                                <input type="radio" name="status_ttd" value="Ya"
                                    ...
                                    required onclick="toggleUploadForm(this)">
                                Ya<br>
                                <input type="radio" name="status_ttd" value="Tidak"
                                    <?= isset($karyawan['status_ttd']) && $karyawan['status_ttd'] == 'Tidak' ? 'checked' : ''; ?>
                                    required onclick="toggleUploadForm(this)">
                                Tidak
                            </div>

                            <div class="form-group" id="uploadForm"
                                <?= isset($karyawan['status_ttd']) && $karyawan['status_ttd'] == 'Ya' ? '' : 'style="display:none;"'; ?>>
                                <label>Upload Tanda Tangan</label> <br>
                                <?php if (isset($karyawan['status_ttd']) && $karyawan['status_ttd'] == 'Ya' && !empty($karyawan['file'])) : ?>
                                <img src="<?= base_url('uploads/ttd/' . $karyawan['file']); ?>" alt="Gambar" width="100"
                                    height="100">
                                <br>
                                <?php endif; ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="keterangan" class="form-control"
                                    value="<?= $karyawan['keterangan']; ?>" required>
                            </div>
